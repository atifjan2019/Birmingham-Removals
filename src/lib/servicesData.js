...
const servicesData = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "House removal costs in Birmingham typically start from around £250 for a 1-bed flat and rise to £1,500 or more for a large 4-bed house. Your fixed quote is based on volume, distance, access and optional extras such as packing, so you only ever pay for what your move actually needs.",
        ],
      },
      {
    ...
    faqs: [
      ...
      { q: "Can you handle tight access and stairs?", a: "Yes. Our crews handle narrow stairs, high-rise lifts and awkward doorways daily, with no hidden surcharges." },
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Out-of-hours moves, including evenings, weekends and bank holidays, come as standard. No disruption to your day-to-day business.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "How Much Does a Packing Service Cost?",
        paragraphs: [
          "A professional packing service in Birmingham starts from around £80 for a 1-bed flat and rises to £400 or more for a full house pack. Every quote includes all boxes, tape, bubble wrap and wardrobe cartons, so there is nothing extra to buy.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "How Much Does Storage Cost in Birmingham?",
        paragraphs: [
          "Storage starts from around £20 per week for a small unit and scales with the volume you need to store. Every unit is fully insured and CCTV-monitored, with flexible weekly terms and no long tie-ins.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Piano skids, heavy-duty straps, custom padding and specialist vehicles ensure every precious item gets individual attention from start to finish.",
          "From an upright in a terraced house to a grand piano in a concert hall, we've moved them all across the West Midlands.",
        ],
      },
      {
        heading: "How Much Does Piano Removal Cost?",
        paragraphs: [
          "Piano removal in Birmingham starts from around £150 for an upright within the West Midlands. Grand pianos, antiques and other specialist or high-value items are quoted individually once we have assessed the access and handling required.",
        ],
      },
      {
