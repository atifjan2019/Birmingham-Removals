        ...
        <section className="relative pt-20 pb-16 bg-gradient-to-br from-[#0A2540] to-[#14375C] text-white overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="font-[family-name:var(--font-space)] text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
              <span className="text-[#FF6B35]">Birmingham removals</span>, tailored to you
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {servicesData.map((service) => (
                <Link
                  ...
                  className="group bg-white border border-slate-200 rounded-2xl p-7 hover:border-[#FF6B35] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col"
                >
                  ...
                  <h2 className="font-[family-name:var(--font-space)] text-xl font-bold mb-3 text-[#0A2540] group-hover:text-[#FF6B35] transition-colors">
                    {service.title}
                  </h2>
