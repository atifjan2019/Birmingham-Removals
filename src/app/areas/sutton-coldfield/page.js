...
const services = [
  ...
  { icon: Building2, name: "Office Removals Sutton Coldfield", desc: "Professional office removals for Sutton Coldfield town centre businesses and The Parade retail units — weekend and evening scheduling to avoid disruption." },
  { icon: Package, name: "Full Packing Service", desc: "White-glove packing for Sutton Coldfield moves — bespoke crating for artwork, specialist piano moving, wardrobe packing service and full inventory documentation." },
  { icon: Warehouse, name: "Storage & Removals", desc: "Premium secure storage alongside your Sutton Coldfield removal — climate-controlled options available for antiques, wine and sensitive items." },
];
...
const whyUs = [
  ...
  { title: "Transparent Premium Pricing", desc: "Our Sutton Coldfield quotes are detailed, written and fixed. No hidden costs, no day-rate ambiguity — a professional service priced fairly for the work involved." },
