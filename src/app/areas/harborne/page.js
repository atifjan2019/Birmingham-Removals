...
const services = [
  ...
  { icon: Building2, name: "Office Removals Harborne", desc: "Out-of-hours office removals for Harborne's clinics, consultancies and High Street businesses, with zero disruption to your working day." },
...
const whyUs = [
  ...
  { title: "5-Star Rated in Harborne", desc: "We've built a 4.9-star Google rating on the back of hundreds of Harborne and Birmingham-wide reviews. Families recommend us to their neighbours, and that's our best advert." },
];
