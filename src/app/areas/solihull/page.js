...
const services = [
  ...
  { icon: Building2, name: "Luxury & Executive Moves", desc: "Specialist removals for high-value Solihull properties, with careful handling of bespoke furniture, antiques, art and oversized items in premium homes throughout B91–B93." },
  ...
  { icon: Building2, name: "Office Removals Solihull", desc: "Professional office and commercial removals for Solihull town centre businesses, Lode Lane offices and tech park units, with flexible scheduling to suit your operation." },
  { icon: Package, name: "Full Packing Service", desc: "White-glove packing for Solihull moves, with every item documented, wrapped and crated to the standard expected in one of the West Midlands' most prestigious postcodes." },
  { icon: Warehouse, name: "Storage & Removals", desc: "Secure, climate-controlled storage alongside your Solihull removal, including chain-break solutions, downsizer storage and temporary storage for renovation moves." },
];
...
const whyUs = [
  ...
  { title: "Fully Insured to Premium Standards", desc: "£10m goods-in-transit and £5m public liability on every Solihull job. High-value items documented with photographs before loading, ensuring full accountability throughout." },
...
const faqs = [
  ...
  { q: "Do you offer same-day removals in Solihull?", a: "For man and van moves in B91–B93, same-day availability is possible, so call before midday. Full house removals in Solihull typically require 48–72 hours' planning to assign the appropriate crew size, vehicle and access arrangements." },
...
const LocalArea = (
  <>
    ...
    <p>
      ...
      <Link href="/areas/erdington" className="text-[#F97316] underline underline-offset-2 hover:text-[#EA580C]">Erdington</Link>, with extra local pages for{" "}
      <Link href="/areas/knowle" className="text-[#F97316] underline underline-offset-2 hover:text-[#EA580C]">Knowle</Link>,{" "}
      <Link href="/areas/dorridge" className="text-[#F97316] underline underline-offset-2 hover:text-[#EA580C]">Dorridge</Link>,{" "}
      <Link href="/areas/balsall-common" className="text-[#F97316] underline underline-offset-2 hover:text-[#EA580C]">Balsall Common</Link> and{" "}
      <Link href="/areas/hampton-in-arden" className="text-[#F97316] underline underline-offset-2 hover:text-[#EA580C]">Hampton-in-Arden</Link>{" "}
