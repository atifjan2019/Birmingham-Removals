...
const services = [
  ...
  { icon: Building2, name: "Office Removals Erdington", desc: "Cost-effective office and commercial removals for Erdington High Street businesses and light industrial units near Tyburn Road — flexible timing to suit your operation." },
...
const whyUs = [
  ...
  { title: "Fully Insured, Every Job", desc: "£10m goods-in-transit and £5m public liability cover on every Erdington removal — flat, house or office, regardless of size." },
  { title: "Transparent, Fixed Pricing", desc: "Erdington is one of our most competitive-priced areas — affordable man and van rates and full removal quotes with no hidden charges." },
...
const LocalArea = (
  <>
    ...
    <p>
      ...
      plan all Erdington removals around these pinch points — early starts on Chester Road are
