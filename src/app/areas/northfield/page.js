...
const services = [
  ...
  { icon: Package, name: "Packing Service", desc: "Full or part-packing in Northfield homes using professional materials. We supply all boxes, tape and wrapping — you don't need to source anything." },
...
const whyUs = [
  ...
  { title: "Competitive, Fixed Pricing", desc: "Northfield is one of our most affordable service areas. Prices are fixed, quoted in writing and never change on move day — no hidden surprises." },
