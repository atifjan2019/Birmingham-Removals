...
const services = [
  ...
  { icon: Truck, name: "Man and Van Kings Heath", desc: "Affordable man and van in Kings Heath for single-room moves, sofa deliveries and light loads — quick turnaround on short-notice bookings throughout B14." },
  { icon: Building2, name: "Office Removals Kings Heath", desc: "Weekend and evening office moves for Kings Heath High Street businesses, clinics and studios — no downtime, no disruption." },
...
const LocalArea = (
  <>
    ...
    <p>
      ...
      Wheelers Lane, the housing transitions to interwar semis — wider plots, through-lounges,
