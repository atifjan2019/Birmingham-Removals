...
const services = [
  ...
  { icon: Building2, name: "Office Removals Edgbaston", desc: "Out-of-hours and weekend office removals across Edgbaston business parks and consulting suites — zero downtime for your practice or firm." },
...
const faqs = [
  ...
  { q: "Do you cover the Edgbaston postcode — B15 and B16?", a: "Yes. We operate daily across B15 (central Edgbaston, Calthorpe Estate, Five Ways) and B16 (Edgbaston western fringe toward Ladywood and Bearwood Road). Both postcodes are within our standard Birmingham coverage — no travel surcharge." },
