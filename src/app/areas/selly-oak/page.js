...
const services = [
  { icon: Home, name: "Student & House Removals Selly Oak", desc: "Fast, affordable end-of-term and September-rush student moves throughout Selly Oak and Bournbrook. Last-minute bookings welcome — we know the student calendar." },
  ...
  { icon: Building2, name: "HMO & Shared House Moves", desc: "Specialist moves for shared houses and HMOs throughout Selly Oak — individual rooms quoted separately, co-ordinated on moving day so each tenant's belongings stay separate." },
