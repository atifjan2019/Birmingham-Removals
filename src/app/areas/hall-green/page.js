...
const services = [
  ...
  { icon: Package, name: "Packing Service", desc: "Professional packing in Hall Green homes — double-walled boxes, furniture blankets and precision wrapping for fragile items, artwork and electronics." },
...
const LocalArea = (
  <>
    <p>
      ...
      characterised by the classic Birmingham semi — bay-fronted three-bedroom houses that
