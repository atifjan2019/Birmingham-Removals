  ...
  return (
    <div className="py-4 text-center">
      ...
      <motion.h2
        ...
        className="font-[family-name:var(--font-space)] text-2xl font-bold text-[#F8FAFC] mb-2"
      >
      ...
      >
        ...
        <strong className="text-[#F8FAFC]">{data.phone}</strong> within 2 hours.
      </motion.p>
      ...
      <motion.div
        ...
        className="bg-white/[0.03] border border-white/10 rounded-xl p-5 text-left space-y-3"
      >
        <div className="text-xs text-[#94A3B8] uppercase tracking-wide font-medium mb-3">
          Your Quote Summary
        </div>

        <div className="flex items-center gap-3">
          <User className="w-4 h-4 text-[#2563EB] shrink-0" />
          <span className="text-[#F8FAFC] text-sm">{data.fullName}</span>
        </div>

        <div className="flex items-center gap-3">
          <Phone className="w-4 h-4 text-[#2563EB] shrink-0" />
          <span className="text-[#F8FAFC] text-sm">{data.phone}</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[#F8FAFC] text-sm">{formattedDate}</span>
        </div>

        <div className="pt-2 border-t border-white/5">
          <span className="text-[#94A3B8] text-xs">Move type: </span>
