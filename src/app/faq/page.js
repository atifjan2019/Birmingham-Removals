...
export const metadata = {
  ...
  description:
    "Common questions about Birmingham removals: prices, booking times, insurance, storage, payment and more. Still not sure? Call us on 0788 886 2003.",
        ...
        <section className="relative pt-20 pb-16 bg-gradient-to-br from-[#0A2540] to-[#14375C] text-white overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="font-[family-name:var(--font-space)] text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
              Your <span className="text-[#FF6B35]">Birmingham removals</span> questions, answered
            </h1>
          </div>
        </section>
        <FAQ />
