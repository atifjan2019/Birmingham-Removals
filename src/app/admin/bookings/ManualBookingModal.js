              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input required name="fromPostcode" type="text" className="w-full pl-9 pr-4 py-2 border border-gray-200 rounded-xl outline-none uppercase" placeholder="B15 3DH" />
